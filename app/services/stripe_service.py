...
def create_payment_intent(amount_usd_cents: int, booking_id: str, customer_email: str) -> dict:
...
def refund_payment_intent(payment_intent_id: str, amount_cents: int | None = None) -> stripe.Refund:
